...
public class SQLiteUtils
{
	...
	/// SQLite数据库辅助类
	/// </summary>
	private SQLiteHelper sql = new SQLiteHelper("data source=story.db");

//	public void createTables(){
//		//创建名为table1的数据表
//		sql.CreateTable ("session", new string[]{ "id", "name", "avatar", "desc", "isShow", "isActive" }, new string[]{ "INTEGER", "TEXT", "TEXT", "TEXT", "INTEGER", "INTEGER" });
//	}

	public SqliteDataReader readSql(string table){
	...
	public void writeHistory(string table, string[] keys, string[] values){
		sql.InsertValues (table, keys, values);
	}
...
//		sql = new SQLiteHelper ("data source=story.db");
//
//		//创建名为table1的数据表
//		sql.CreateTable ("session", new string[]{ "id", "name", "avatar", "desc", "isShow", "isActive" }, new string[]{ "INTEGER", "TEXT", "TEXT", "TEXT", "INTEGER", "INTEGER" });
//
//		//插入两条数据
//		sql.InsertValues ("session", new string[]{ "'1'", "'张三'", "'22'", "'Zhang3@163.com'" });
//		sql.InsertValues ("session", new string[]{ "'2'", "'李四'", "'25'", "'Li4@163.com'" });
//
